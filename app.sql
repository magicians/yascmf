...
-- ----------------------------
-- Table structure for app_contents
-- ----------------------------
...
-- ----------------------------
-- Records of app_flags
-- ----------------------------
INSERT INTO `app_flags` VALUES ('1', 'l', 'link', '链接', '可用于友情链接');
INSERT INTO `app_flags` VALUES ('2', 'f', 'flash', '幻灯', '可用于页面幻灯片模型');
INSERT INTO `app_flags` VALUES ('3', 's', 'scrolling', '滚动', '可用于页面滚动效果的文章');
INSERT INTO `app_flags` VALUES ('4', 'h', 'hot', '热门', '可用于页面推荐性文章');
...
-- ----------------------------
INSERT INTO `app_metas` VALUES ('1', '默认', null, 'default', 'category', '默认', '0', '0');
INSERT INTO `app_metas` VALUES ('2', '软件', null, 'soft', 'category', '收录个人开发的软件或脚本', '0', '0');
INSERT INTO `app_metas` VALUES ('3', '文档', null, 'docs', 'category', '这里收录自己开发过程中所撰写的文档', '0', '0');
INSERT INTO `app_metas` VALUES ('4', 'Laravel', null, 'laravel', 'category', '分享一些Laravel相关文章', '0', '0');
INSERT INTO `app_metas` VALUES ('5', 'Javascript', null, 'javascript', 'category', '前端Javascript相关知识', '0', '0');
INSERT INTO `app_metas` VALUES ('6', '测试', null, null, 'category', '测试内容', '0', '0');
...
-- ----------------------------
INSERT INTO `app_permissions` VALUES ('1', 'manage_contents', '管理内容', null, '2014-12-22 02:30:59', '2014-12-22 02:30:59');
INSERT INTO `app_permissions` VALUES ('2', 'manage_users', '管理用户', null, '2014-12-22 02:30:59', '2014-12-22 02:30:59');
INSERT INTO `app_permissions` VALUES ('3', 'manage_system', '管理系统', null, '2015-02-04 09:40:56', '2015-02-04 09:40:59');
...
-- ----------------------------
INSERT INTO `app_permission_role` VALUES ('1', '2');
INSERT INTO `app_permission_role` VALUES ('1', '3');
INSERT INTO `app_permission_role` VALUES ('2', '1');
INSERT INTO `app_permission_role` VALUES ('2', '2');
INSERT INTO `app_permission_role` VALUES ('3', '1');
INSERT INTO `app_permission_role` VALUES ('3', '2');

-- ----------------------------
-- Table structure for app_relationships
-- ----------------------------
...
-- ----------------------------
INSERT INTO `app_roles` VALUES ('1', 'Founder', '创始人', null, '2014-12-22 02:30:59', '2014-12-22 02:30:59');
INSERT INTO `app_roles` VALUES ('2', 'Admin', '超级管理员', null, '2014-12-22 02:30:59', '2014-12-22 02:30:59');
INSERT INTO `app_roles` VALUES ('3', 'Editor', '编辑', null, '2015-02-04 17:12:22', '2015-02-04 17:12:22');
INSERT INTO `app_roles` VALUES ('4', 'Demo', '演示', null, '2015-02-04 17:13:03', '2015-02-04 17:13:03');
...
-- ----------------------------
INSERT INTO `app_role_user` VALUES ('1', '2');
...
-- ----------------------------
INSERT INTO `app_settings` VALUES ('1', 'default_setting', '默认设置', '1', '1', '999');
INSERT INTO `app_settings` VALUES ('2', 'system', '系统', '1', '2', '0');
INSERT INTO `app_settings` VALUES ('3', 'manager', '管理员', '1', '2', '0');
INSERT INTO `app_settings` VALUES ('4', 'content', '内容', '1', '2', '0');
INSERT INTO `app_settings` VALUES ('5', 'upload', '上传', '1', '2', '0');
INSERT INTO `app_settings` VALUES ('6', 'article', '文章', '1', '3', '0');
INSERT INTO `app_settings` VALUES ('7', 'page', '单页', '1', '3', '0');
INSERT INTO `app_settings` VALUES ('8', 'fragment', '碎片', '1', '3', '0');
INSERT INTO `app_settings` VALUES ('9', 'memo', '备忘', '1', '3', '0');
INSERT INTO `app_settings` VALUES ('10', 'Founder', '创始人', '1', '4', '0');
INSERT INTO `app_settings` VALUES ('11', 'Admin', '超级管理员', '1', '4', '0');
INSERT INTO `app_settings` VALUES ('12', 'Editor', '编辑', '1', '4', '0');
INSERT INTO `app_settings` VALUES ('13', 'Demo', '演示', '1', '4', '0');
...
-- ----------------------------
-- Records of app_setting_type
-- ----------------------------
INSERT INTO `app_setting_type` VALUES ('1', 'default', '默认', '0');
INSERT INTO `app_setting_type` VALUES ('2', 'system_operation', '系统操作类型', '0');
INSERT INTO `app_setting_type` VALUES ('3', 'content_type', '内容类型', '0');
INSERT INTO `app_setting_type` VALUES ('4', 'role_type', '角色类型', '0');
...
-- ----------------------------
-- Table structure for app_system_options
-- ----------------------------
DROP TABLE IF EXISTS `app_system_options`;
CREATE TABLE `app_system_options` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'id',
...
-- ----------------------------
-- Records of app_system_options
-- ----------------------------
INSERT INTO `app_system_options` VALUES ('1', 'website_keywords', '芽丝博客,芽丝,CMF,内容管理框架');
INSERT INTO `app_system_options` VALUES ('2', 'company_address', '');
INSERT INTO `app_system_options` VALUES ('3', 'website_title', '芽丝博客');
INSERT INTO `app_system_options` VALUES ('4', 'company_telephone', '800-168-8888');
INSERT INTO `app_system_options` VALUES ('5', 'company_full_name', '芽丝内容管理框架');
INSERT INTO `app_system_options` VALUES ('6', 'website_icp', '');
INSERT INTO `app_system_options` VALUES ('7', 'system_version', 'app_alpha_1.0');
INSERT INTO `app_system_options` VALUES ('8', 'page_size', '10');
INSERT INTO `app_system_options` VALUES ('9', 'system_logo', 'http://cmf.yas.so/assets/img/yas_logo.png');
INSERT INTO `app_system_options` VALUES ('10', 'picture_watermark', 'http://cmf.yas.so/assets/img/yas_logo.png');
INSERT INTO `app_system_options` VALUES ('11', 'company_short_name', '芽丝博客');
INSERT INTO `app_system_options` VALUES ('12', 'system_author', '豆芽丝');
INSERT INTO `app_system_options` VALUES ('13', 'system_author_website', 'http://douyasi.com');
INSERT INTO `app_system_options` VALUES ('14', 'is_watermark', '0');
...
-- ----------------------------
INSERT INTO `app_users` VALUES ('1', 'admin', '$2y$10$J7LHukU1OvdKS0HjHyP67OckaKXwci9vV6iqOCpN65x8X7MDgMNlu', 'Admin', 'admin@example.com', '芽丝', null, null, null, null, null, null, null, null, null, '2014-12-22 02:30:59', '2015-04-26 19:26:04', '0', 'manager', '161590b511f23a7aca43e785ba037d4f', '1', 'GFdBArEXF5jmURqJwsiVfNjZg2AmmR4kBX0Wtgw9djGZgsO6D3G8XZGMTxg9');
